...
# 文案守門與其常數已抽出至 guards.py（純函式、不需 fastf1/genai，可獨立測試與 demo）
from guards import (SESSION_LABEL, STATIC_RULES, factcheck_post_numbers,
                    strip_template_lines, validate_post_static)
